...
$page = 'Netto'; // sidens navn
$shareimage = 'shareimages_case_netto.png'; // share image
$pagedescription = '';

include '../start.php' ?>


<section id="header_section" class="case_headsection netto">
  <img src="<?=$sitepath?>assets/images/netto.png" alt="" class="page_img">
  <div class="wrapper case_header" id="first_section">
    <div class="center_header">
    <h1 class="init_reveal_fadeup" style="transition-delay: 200ms;">Netto <br>
</h1>
