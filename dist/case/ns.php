...
<section id="header_section" class="case_headsection ns">
  <img src="<?=$sitepath?>assets/images/ns.png" alt="" class="page_img">
  <div class="wrapper case_header" id="first_section">
    <div class="center_header">
    <h1 class="init_reveal_fadeup" style="transition-delay: 200ms;">Næstved Storcenter <br>
</h1>
