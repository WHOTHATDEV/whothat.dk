...
$page = 'Zoo'; // sidens navn
$shareimage = 'shareimages_case_zoo.png'; // share image
$pagedescription = '';

include '../start.php' ?>


<section id="header_section" class="case_headsection zoo">
  <img src="<?=$sitepath?>assets/images/zoo.png" alt="" class="page_img">
