...
$page = 'Raadhuskroen'; // sidens navn
$shareimage = 'shareimages_case_raadhuskroen.png'; // share image
$pagedescription = '';

include '../start.php' ?>


<section id="header_section" class="case_headsection raadhuskroen">
  <img src="<?=$sitepath?>assets/images/raadhuskroen.png" alt="" class="page_img">
  <div class="wrapper case_header" id="first_section">
    <div class="center_header">
    <h1 class="init_reveal_fadeup" style="transition-delay: 200ms;">Raadhuskroen <br>
</h1>
    <h2 class="init_reveal_fadeup" style="transition-delay: 400ms;">****** ****** ***** *****</h2>
    </div>
  </div>

  <div class="hashtags ">
    <span class="init_reveal_fadeup" style="transition-delay: 600ms;">#*****</span>
    <span class="init_reveal_fadeup" style="transition-delay: 700ms;">#*****</span>
    <span class="init_reveal_fadeup" style="transition-delay: 800ms;">#*****</span>
    <span class="init_reveal_fadeup" style="transition-delay: 900ms;">#*****</span>
  </div>
