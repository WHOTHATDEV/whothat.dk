...
$page = 'Fedtjob'; // sidens navn
$shareimage = 'shareimages_case_fedtjob.png'; // share image
$pagedescription = '';

include '../start.php' ?>


<section id="header_section" class="case_headsection fedtjob">
  <img src="<?=$sitepath?>assets/images/fedtjob.png" alt="" class="page_img">
  <div class="wrapper case_header" id="first_section">
    <div class="center_header">
    <h1 class="init_reveal_fadeup" style="transition-delay: 200ms;">Zoo <br>
</h1>
